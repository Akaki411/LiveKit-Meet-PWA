...
const ChatImage = ({
  ...
  <button type="button" className={styles.chatImageBtn} onClick={() => onOpen(src, name)}>
    <img className={styles.chatImage} src={src} alt={name} />
  </button>
);
...
const AttachmentView = ({
  ...
  return (
    <a className={styles.chatFile} href={attachment.url} target="_blank" rel="noopener noreferrer">
