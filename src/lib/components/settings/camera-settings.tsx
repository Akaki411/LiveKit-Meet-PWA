...
import styles from '../../../styles/generated/settings-menu.classes';

const BACKGROUND_IMAGES = [
  { nameKey: 'settings.backgroundWall', path: '/background-images/wall_texture_fullhd.webp' },
  { nameKey: 'settings.backgroundRoom', path: '/background-images/room_bg_fullhd.webp' },
] as const;
